  ...
  return (
    <>
      <div className="max-w-[1321px] h-auto md:h-[461px] bg-white md:mx-auto mt-6">
        <h1 className="font-semibold text-[#272343] text-[26px] md:text-[32px] py-8 md:mb-8 flex justify-center">
          Our Products
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4 md:ml-0">
            <Image
              src="/featured-product-img/image.png"
              alt="chair"
              height={312}
              width={312}
            />
          ...
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4">
            <Image
              src="/featured-product-img/image (1).png"
              alt="chair"
              height={312}
              width={312}
            />
          ...
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4">
            <Image
              src="/featured-product-img/image (2).png"
              alt="chair"
              height={312}
              width={312}
            />
          ...
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4">
            <Image
              src="/featured-product-img/image (3).png"
              alt="chair"
              height={312}
              width={312}
            />
          ...
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4 md:ml-0">
            <Image
              src="/ourProducts-img/image (5).png"
              alt="chair"
              height={312}
              width={312}
            />
          ...
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4">
            <Image
              src="/ourProducts-img/image (6).png"
              alt="chair"
              height={312}
              width={312}
            />
          ...
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4">
            <Image
              src="/ourProducts-img/image (7).png"
              alt="chair"
              height={312}
              width={312}
            />
          ...
          <div className="w-[312px] h-[377px] relative ml-2 sm:ml-4">
            ...
            <div className="flex justify-between mt-3 items-center">
              ...
              <div className="hover:bg-[#8dc6cb] bg-[#eeeeee] text-black hover:text-white rounded-lg px-3 py-3"><LuShoppingCart size={20}/></div>
            </div>
          </div>
      ...
      <div className="mb-48 md:mb-[550px]"></div>
    </>
  );
}
