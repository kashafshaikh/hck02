...
const ShippingRatesPage = () => {
  ...
  const [shipeToAddress, setshipeToAddress] = useState<Address>({
    ...
    cityLocality: "",
    stateProvince: "DC", // Read-only
    postalCode: "20500", // Read-only
    countryCode: "US", // Read-only
    addressResidentialIndicator: "yes", // 'no' means a commercial address
  });
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <input
                ...
                className="p-3 border border-gray-300 rounded-md bg-gray-200"
              />
              <input
                type="text"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:bg-gray-400 transition duration-200"
          >
        ...
        {rateId && (
          <div className="mt-8">
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-gray-400 transition duration-200"
            >
        ...
        {errors.length > 0 && (
          <div className="mt-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Errors</h2>
